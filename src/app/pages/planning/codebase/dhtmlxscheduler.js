...
window.dhtmlXScheduler = window.scheduler = {
    ...
    function() {
        ...
        function a(t, i, s) {
            ...
            var d = "",
                l = !1;
            if (t.width && (a.style.width = t.width), t.height && (a.style.height = t.height), t.title && (d += '<div class="dhtmlx_popup_title" id="' + n + '">' + t.title + "</div>", l = !0), d += '<div class="dhtmlx_popup_text" ' + (l ? "" : ' id="' + n + '" ') + "><span>" + (t.content ? "" : t.text) + '</span></div><div  class="dhtmlx_popup_controls">',
                i) {
...
var dataProcessor = window.dataProcessor = function(e) {
    return this.serverProcessor = e, this.action_param = "!nativeeditor_status", this.object = null, this.updatedRows = [], this.autoUpdate = !0, this.updateMode = "cell", this._tMode = "GET", this._headers = null, this._payload = null, this.post_delim = "_", this._waitMode = 0, this._in_progress = {}, this._invalid = {},
        this.mandatoryFields = [], this.messages = [], this.styles = {
...
dataProcessor.prototype = {
    setTransactionMode: function(e, t) {
        "object" == typeof e ? (this._tMode = e.mode || this._tMode, void 0 !== e.headers && (this._headers = e.headers),
    ...
    setUpdated: function(e, t, i) {
        if (!this._silent_mode) {
            ...
            s && "updated" == i && (i = s), t ? (this.set_invalid(e, !1), this.updatedRows[r] = e, this.obj.setUserData(e, this.action_param, i),
                this._in_progress[e] && (this._in_progress[e] = "wait")) : this.is_invalid(e) || (this.updatedRows.splice(r, 1), this.obj.setUserData(e, this.action_param, "")), t || this._clearUpdateFlag(e), this.markRow(e, t, i), t && this.autoUpdate && this.sendData(e)
        }
    },
    ...
    serialize: function(e, t) {
        ...
        return i.push("ids=" + this.escape(r.join(","))),
    ...
    _applyPayload: function(e) {
        var t = this.obj.$ajax;
        if (this._payload)
            for (var i in this._payload) e = e + t.urlSeparator(e) + this.escape(i) + "=" + this.escape(this._payload[i]);
        return e
    },
    ...
    dhtmlxEventable(scheduler), scheduler._detachDomEvent = function(e, t, i) {
            ...
            t = t || scheduler._currentDate(), i = i || "week", this._obj && this.unset_actions(), this._obj = "string" == typeof e ? document.getElementById(e) : e, this.$container = this._obj, this.config.wai_aria_attributes && this.config.wai_aria_application_role && this.$container.setAttribute("role", "application"), this._skin_init && scheduler._skin_init(), scheduler.date.init(), this._els = [], this._scroll = !0, this._quirks = _isIE && "BackCompat" == document.compatMode,
            ...
            scheduler._is_material_skin() ? (s || (s = document.createElement("div"), s.className = "dhx_cal_scale_placeholder", this.$container.insertBefore(s, this._els.dhx_cal_header[0])), s.style.display = "block", this.set_xy(s, e, this.xy.scale_height + 1, 0, this.xy.nav_height + (this._quirks ? -1 : 1))) : s && s.parentNode.removeChild(s),
            ...
            e.style.width = Math.max(0, t) + "px", e.style.height = Math.max(0, i) + "px", arguments.length > 3 && (e.style.left = r + "px",
                e.style.top = s + "px")
            ...
            var d = new Date(t);
            a.valueOf() == d.valueOf() && d.setTime(d.valueOf() + s), r.start_date = r.start_date || a, r.end_date = r.end_date || d, r.text = r.text || this.locale.labels.new_event,
                r.id = this._drag_id = r.id || this.uid(), this._drag_mode = "new-size", this._loading = !0;
            ...
            if (this._drag_mode) {
                ...
                if (this._is_pos_changed(this._drag_pos, t)) {
                    ...
                    var l, o = this.getEvent(this._drag_id);
                    if (scheduler.matrix && (l = scheduler.matrix[scheduler._mode]), l = l || {
                            x_step: 1,
                            x_unit: "day"
                        }, "move" == this._drag_mode) i = this._min_date.valueOf() + 6e4 * (t.y * this.config.time_step + 24 * t.x * 60 - (scheduler._move_pos_shift || 0)), !t.custom && this._table_view && (i += 1e3 * this.date.time_part(o.start_date)), i = this._correct_shift(i), t._ignores && this.config.preserve_length && this._table_view ? (i = scheduler._correct_drag_start_date(i),
                        r = scheduler._correct_drag_end_date(i, this._drag_event._event_length)) : r = o.end_date.valueOf() - (o.start_date.valueOf() - i);
                    else {
                    ...
                    if ("move" == this._drag_mode && scheduler.config.limit_drag_out && (+v < +scheduler._min_date || +r > +scheduler._max_date)) {
                        if (+o.start_date < +scheduler._min_date || +o.end_date > +scheduler._max_date) v = new Date(o.start_date), r = new Date(o.end_date);
                        else {
                            var m = r - v; + v < +scheduler._min_date ? (v = new Date(scheduler._min_date), t._ignores && this.config.preserve_length && this._table_view ? (v = new Date(scheduler._correct_drag_start_date(v)), l._start_correction && (v = new Date(v.valueOf() + l._start_correction)),
                                ...
                                r = scheduler.date.add(r, l.x_step, l.x_unit))) : v = new Date(+r - m))
                        }
                        var f = new Date(r - 1)
                    }
                    ...
                    if (this._table_view || f.getDate() == v.getDate() && f.getHours() < this.config.last_hour || scheduler._allow_dnd)
                        if (o.start_date = v,
                            o.end_date = new Date(r), this.config.update_render) {
            ...
            for (var o = 0; d > o; o++) {
                if (this._ignores[o] || this._render_x_header(o, l, n, e), !this._table_view) {
                    var h = document.createElement("div"),
                        _ = "dhx_scale_holder";
                    n.valueOf() == s.valueOf() && (_ = "dhx_scale_holder_now"), this._ignores_detected && this._ignores[o] && (_ += " dhx_scale_ignore"),
                        h.className = _ + " " + this.templates.week_date_class(n, s), this._waiAria.dayColumnAttr(h, n), this._set_scale_col_size(h, this._cols[o], l), t.appendChild(h), this.callEvent("onScaleAdd", [h, n])
                }
            ...
            if (this.templates[this._mode + "_date"]) {
                ...
                if (this._els.dhx_cal_date[0].innerHTML = l, this._waiAria.navBarDateAttr(this._els.dhx_cal_date[0], l), this._max_date = d, scheduler._render_scales(e, t), this._table_view) this._reset_month_scale(t, n, a);
                    ...
                    var u = c.cloneNode(!0);
                    u.className = o + "_icon", u.style.visibility = "hidden", this.set_xy(u, this.xy.scale_width, 0, 0, _),
                        c.appendChild(u), this._els[o] = [c, u], this._els[o][0].onclick = this._click.dhx_cal_data
                }
            }
        ...
        function() {
            ...
            scheduler._waiAria = {
                ...
                lightboxAttr: function(e) {
                    e.setAttribute("role", "dialog"), e.setAttribute("aria-hidden", "true"),
            ...
            getOffsetRect: function(e) {
                ...
                if (/Mobi/.test(navigator.userAgent)) {
                    ...
                    s.style.position = "absolute",
                        s.style.left = "0px", s.style.top = "0px", s.style.width = "1px", s.style.height = "1px", document.body.appendChild(s);
            ...
            _call: function(e, t, i, r, s, a, n) {
                ...
                if (r && (l.onreadystatechange = function() {
                    ...
                    }), "GET" != e || this.cache || (t += (t.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (new Date).getTime() + "=1"), l.open(e, t, r), n)
                    for (var h in n) l.setRequestHeader(h, n[h]);
        ...
        function() {
            ...
            if (e = this._table_view ? this._pre_render_events_table(e, t) : this._pre_render_events_line(e, t), this._table_view)
                if (t) this._colsS.heights = r;
                    ...
                    if (n.rows) {
                        ...
                        x.style.height = m, x.style.visibility = -1 == s[0] ? "hidden" : "visible",
            ...
            for (var s = 0; s < e.length; s++) {
                ...
                if (a._sday = this._get_event_sday(a), this._ignores[a._sday]) e.splice(s, 1), s--;
                    ...
                    if (i[a._sday] || (i[a._sday] = []), !t) {
                        ...
                        h.splice(u, u == h.length ? 0 : 1, a), h.length > (h.max_count || 0) ? (h.max_count = h.length,
                            a._count = h.length) : a._count = a._count ? a._count : 1
            ...
            for (var i, r = [], s = [
                    ...
                    [],
                    []
                ], a = this._colsS.heights, n = this._cols.length, d = {}, l = 0; l < e.length; l++) {
                var o = e[l],
                    h = o.id;
                d[h] || (d[h] = {
                    first_chunk: !0,
                ...
                c < this._min_date && (_.first_chunk = !1,
                    c = this._min_date), u > this._max_date && (_.last_chunk = !1, u = this._max_date);
                ...
                if (o._sday = g % n, !this._ignores[o._sday] || !o._timed) {
                    ...
                    if (o._sorder && t || (o._sorder = v), o._sday + o._length <= n) i = null, r.push(o), m[v] = o, a[o._sweek] = m.length - 1, o._first_chunk = _.first_chunk,
                        o._last_chunk = _.last_chunk;
                    else {
            ...
            if (!(e._sday < 0)) {
                ...
                if (r) {
                    ...
                    if (this._waiAria.eventAttr(e, g), this._rendered.push(g), r.appendChild(g), h = h + parseInt(r.style.left, 10) + i, this._edit_id == e.id) {
                        g.style.zIndex = 1, o = Math.max(o - 4, scheduler.xy.editor_width), g = document.createElement("div"), g.setAttribute("event_id", e.id), this._waiAria.eventAttr(e, g), this.set_xy(g, o, n - 20, h, a + (scheduler.xy.event_header_height || 14)),
                            g.className = "dhx_cal_event dhx_cal_editor", e.color && (g.style.backgroundColor = e.color);
                        var f = scheduler.templates.event_class(e.start_date, e.end_date, e);
                        f && (g.className += " " + f);
                        var v = document.createElement("div");
                        this.set_xy(v, o - 6, n - 26), v.style.cssText += ";margin:2px 2px 2px 2px;overflow:hidden;", g.appendChild(v), this._els.dhx_cal_data[0].appendChild(g), this._rendered.push(g), v.innerHTML = "<textarea class='dhx_cal_editor'>" + e.text + "</textarea>", this._quirks7 && (v.firstChild.style.height = n - 12 + "px"), this._editor = v.firstChild,
                    ...
                    if (0 !== this.xy.menu_width && this._select_id == e.id) {
                        ...
                        for (var m, p = this.config["icons_" + (this._edit_id == e.id ? "edit" : "select")], x = "", b = e.color ? "background-color: " + e.color + ";" : "", y = e.textColor ? "color: " + e.textColor + ";" : "", w = 0; w < p.length; w++) m = this._waiAria.eventMenuAttrString(p[w]), x += "<div class='dhx_menu_icon " + p[w] + "' style='" + b + y + "' title='" + this.locale.labels[p[w]] + "'" + m + "></div>";
            ...
            if (a) {
                ...
                d && (p += n), "month" == scheduler.getState().mode && (e = scheduler.getEvent(e.id)), e._timed && (p += scheduler.templates.event_bar_date(e.start_date, e.end_date, e)),
                    p += scheduler.templates.event_bar_text(e.start_date, e.end_date, e) + "</div>", p += "</div>", l.innerHTML = p, this._rendered.push(l.firstChild), t.appendChild(l.firstChild)
            }
            ...
            time: {
                ...
                set_value: function(e, t, i, r) {
                    function s(e, t, i) {
                        ...
                        e[t + o[0]].value = d ? a : n,
                            d || n || (e[t + o[0]].selectedIndex = -1), e[t + o[1]].value = i.getDate(), e[t + o[2]].value = i.getMonth(), e[t + o[3]].value = i.getFullYear()
                    }
                    ...
                    if (d.full_day) {
                        ...
                        _.checked = 0 === scheduler.date.time_part(i.start_date) && 0 === scheduler.date.time_part(i.end_date), l[o[0]].disabled = _.checked, l[o[0] + l.length / 2].disabled = _.checked, _.onclick = function() {
                            ...
                            l[o[0]].disabled = _.checked, l[o[0] + l.length / 2].disabled = _.checked,
                                s(l, 0, a || i.start_date), s(l, 4, n || i.end_date)
                        }
                    }
            ...
            function a(e) {
                if (!i(e)) {
                    ...
                    return "create" == t && r && (scheduler.render_view_data = function() {
                            for (var e = scheduler.getState().drag_id, t = scheduler.getEvent(e), i = r.y_property, s = scheduler.getEvents(t.start_date, t.end_date), a = 0; a < s.length; a++) s[a][i] != t[i] && (s.splice(a, 1), a--);
                            t._sorder = s.length - 1, t._count = s.length, this.render_data([t], scheduler.getState().mode)
                        }), scheduler._on_mouse_move(e),
                        "create" == t && r && (scheduler.render_view_data = s), e.preventDefault && e.preventDefault(), e.cancelBubble = !0, !1
                }
            }
            ...
            var t = scheduler.setCurrentView,
                ...
                a = function(t, a) {
                    ...
                    e(this, t, a), s = setTimeout(function() {
                        return n.callEvent("onBeforeViewChange", [l, d, a || n._mode, t || n._date]) ? (i.call(n, t, a), n.callEvent("onViewChange", [n._mode, n._date]), window.clearTimeout(r), void(s = 0)) : void e(n, d, l)
