...
export class InfoPanelsComponent {
  ...
  public sales = [{ name:'Infos1', value:0.81, extra: { format: 'percent' } }];
  public salesBgColor = { domain: ['#2F3E9E'] };

  public likes = [{ name:'Infos2', value:47588 }];
  public likesBgColor = { domain: ['#D22E2E'] };

  public downloads = [{ name:'Infos3', value:189730 }];
  public downloadsBgColor = { domain: ['#378D3B'] };

  public profit = [{ name:'Infos4', value:52470, extra: { format: 'currency' } }];
  public profitBgColor = { domain: ['#0096A6'] };

  public messages = [{ name:'Infos5', value:75296 }];
  public messagesBgColor = { domain: ['#606060'] };

  public members = [{ name:'Infos6', value:216279 }];
