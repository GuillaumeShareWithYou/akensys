...
export class MenuService {
  ...
  public createHorizontalMenu(menu:Array<Menu>, nativeElement){
    ...
    menu.forEach((menuItem) => {
      ...
      console.log("menu id");
      this.compo.donnees["c1"];//.map(function(a) {return a["c1"];});
      console.log(this.compo.donnees["c1"]);
      if (!((menuItem.code=="M_MAIN") && (this.compo.donnees["c1"]=="ok"))){
